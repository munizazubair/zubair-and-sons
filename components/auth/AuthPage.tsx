...
const [isSubmitted, setIsSubmitted] = useState(false);
  ...
  // Initialized from ?mode=signup or ?mode=signin in the URL so the
  // "Sign In" / "Sign Up" buttons in the navbar can deep-link directly
...
const { error: signUpError } = await supabase.auth.signUp({
 ...
 className="mt-5 space-y-3.5" noValidate>
