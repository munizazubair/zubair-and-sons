...
export default function App() {
  // Navigation View State: 'landing' | 'auth'
    ...
    return (
      <AuthPage
        ...
        onSuccess={(name) => {
          ...
          setWelcomeToast(`Welcome back, ${name}! Your profile is fully synchronized.`);
          ...
          <div className="hidden md:block">
            {loggedInUser ? (
              <div className="flex items-center gap-4">
                <span className="text-sm font-medium text-slate-300 bg-white/5 border border-white/10 px-4 py-2 rounded-full flex items-center gap-2">
                ...
                <button 
                  ...
                  className="px-5 py-2.5 rounded-full border border-brand-orange/50 text-xs font-semibold uppercase tracking-wider text-brand-orange hover:bg-brand-orange/10 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-orange/30"
                >
                  Sign out
                </button>
              </div>
          ...
          <div className="flex flex-col gap-4 items-center w-full">
            {loggedInUser ? (
              <div className="flex flex-col gap-3 items-center w-full">
                <span className="text-sm font-medium text-slate-300 bg-white/5 border border-white/10 px-5 py-3 rounded-full flex items-center justify-center gap-2 w-full">
