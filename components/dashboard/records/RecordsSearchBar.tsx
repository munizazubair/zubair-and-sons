...
export default function RecordsSearchBar({ value, onChange }: RecordsSearchBarProps) {
  return (
    <div className="relative flex-1" id="records-search-bar-container">
      ...
      <input
        ...
        type="text"
        placeholder="Search payment records by customer name..."
        value={value}
